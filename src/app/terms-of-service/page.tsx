...
const termsSections = [
  ...
  {
    title: "Governing Law",
    content: <WordHighlighter text="This agreement shall be governed by and interpreted in accordance with the laws of Pakistan. Any disputes arising from these terms and conditions will be subject to the exclusive jurisdiction of the courts located in Lahore, Pakistan." />
  },
  {
    title: "Termination",
...
export default function TermsOfServicePage() {
  return (
    <div className="bg-transparent text-foreground relative overflow-hidden">
        ...
        <BlurCircle className="absolute top-[-10rem] right-[-10rem] w-96 h-96 -z-10" />
        <BlurCircle className="absolute bottom-[-15rem] left-[-15rem] w-96 h-96 -z-10" />
