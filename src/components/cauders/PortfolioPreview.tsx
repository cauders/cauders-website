...
export default function PortfolioPreview() {
  ...
  return (
    <div
      ref={sectionRef}
      className="relative flex flex-col justify-center h-full w-full pointer-events-none"
          ...
          {projects.map((project, index) => {
            ...
            return (
              <div
                ...
                className="absolute w-[95vw] md:w-[60vw] lg:w-[45vw] xl:w-[35vw] h-full group top-0 left-0 right-0 mx-auto pointer-events-auto"
