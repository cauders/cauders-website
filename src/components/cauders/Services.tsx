                              ...
                              <div className="flip-card-inner relative w-full h-full">
                                  ...
                                  <div className="flip-card-back absolute w-full h-full">
                                    <div className="relative w-full h-full bg-foreground/90 rounded-lg overflow-hidden">
                                      ...
                                      <Card className={cn("relative z-10 h-full flex flex-col justify-start items-center text-center glass-effect animated-border-card border-border/20 px-6 pb-6 pt-10")}>
