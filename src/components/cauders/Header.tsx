        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14">
            ...
            <div className="flex items-center gap-4">
              <Button onClick={() => setIsMenuOpen(true)} variant="ghost" className={cn("text-xl font-medium", isHeroVisible ? 'text-white hover:bg-white/10 hover:text-white' : 'text-foreground hover:bg-accent')} aria-label="Open menu">
                Menu
              </Button>
            </div>
          </div>
