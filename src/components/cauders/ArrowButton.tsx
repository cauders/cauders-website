    ...
    <Link href={href} className={cn("inline-flex group", className)}>
      <div className="relative inline-flex items-center justify-center overflow-hidden transition-all duration-300 ease-out">
        <div className="flex items-center gap-1">
          <div className="border-2 border-white text-white px-6 py-2.5 rounded-bl-3xl rounded-tr-[2px] rounded-br-[2px] group-hover:bg-white group-hover:text-black transition-colors duration-300">
            <span className="text-sm font-medium">{text}</span>
          </div>
          <div className="border-2 border-white bg-white p-3 rounded-[2px]">
