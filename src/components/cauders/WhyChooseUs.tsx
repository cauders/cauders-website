        ...
        <section className="py-20 lg:py-32 bg-background">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12 lg:mb-20">
                    <StandardizedHeading lines={["Why People", { text: "Choose Cauders", className: "bg-gradient-text text-transparent bg-clip-text" }]} className="font-medium text-3xl sm:text-4xl md:text-5xl" />
                    <ScrollFadeIn>
