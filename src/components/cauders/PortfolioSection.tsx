        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollFadeIn>
            <div className="flex flex-col items-center justify-center gap-4">
              ...
              <StandardizedHeading lines={["Explore Our Work"]} className="text-background" />
            </div>
          </ScrollFadeIn>
          ...
          <div className="text-center mt-32 max-w-xl mx-auto">
            ...
            <Button asChild variant="outline" className="mt-8 bg-transparent border-2 border-white text-white hover:bg-white hover:text-foreground px-12">
