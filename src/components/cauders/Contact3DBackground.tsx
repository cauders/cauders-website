...
function Scene() {
  return (
    <>
      ...
      <AnimatedSphere position={[-2.5, -1, -5]} color="hsl(var(--primary))" />
      <AnimatedSphere position={[3, 2, -6]} color="hsl(var(--foreground))" />
      <AnimatedSphere position={[1, -2.5, -4]} color="hsl(var(--secondary))" />
    </>
  );
}
